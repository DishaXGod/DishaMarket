{
    shop = {
		...
		{text = "Изумрудная монета", buyPrice = 20000, sellPrice = 5000, minCount = 0, maxCount = 1000, fingerprint = {{dmg=0.0,id="customnpc:NpcCoinEmerald"}}, raw_name = {"item.npccoinemerald"}},
		{text = "Золотая монета", buyPrice = 15000,  sellPrice = 4000, minCount = 0, maxCount = 1000, fingerprint = {{dmg=0.0,id="customnpc:NpcCoinGold"}}, raw_name = {"item.npccoingold"}},
		{text = "Железная монета", buyPrice = 10000, sellPrice = 2000, minCount = 0, maxCount = 1000, fingerprint = {{dmg=0.0,id="customnpc:NpcCoinIron"}}, raw_name = {"item.npccoiniron"}},
		{text = "Каменная монета", buyPrice = 5000, sellPrice = 1000, minCount = 0, maxCount = 1000, fingerprint = {{dmg=0.0,id="customnpc:NpcCoinStone"}}, raw_name = {"item.npccoinstone"}},
		{text = "Деревянная монета", buyPrice = 3000, sellPrice = 500, minCount = 0, maxCount = 1000, fingerprint = {{dmg=0.0,id="customnpc:NpcCoinWooden"}}, raw_name = {"item.npccoinwooden"}},
