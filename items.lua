...
--		{text = "Улучшение "Энергохранитель"", buyPrice = 1500, minCount = 0, maxCount = 50000, fingerprint = {{dmg=2.0,id="IC2:upgradeMonule"}}, raw_name = {"ic2.energystorageupgrade"}},
--		{text = "Улучшение "Выталкиватель"", buyPrice = 1500, minCount = 0, maxCount = 5000, fingerprint = {{dmg=3.0,id="IC2:upgradeMonule"}}, raw_name = {"ic2.ejectorupgrade"}},
...
--		{text = "Мифриловый слиток", buyPrice = 250, minCount = 0, maxCount = 15000, fingerprint = {{dmg=70.0,id="ThermalFoundation:material"}}, raw_name = {"item.thermalfoundation.material.ingotmithril"}},
...
--		{text = "Осколок хаоса", buyPrice = 100000, minCount = 0, maxCount = 1000, fingerprint = {{dmg=0.0,id="DraconicEvolution:chaousShard"}}, raw_name = {"item.draconicEvolution:chaousshard"}},
		...
		{text = "Пульсирующая сеть", buyPrice = 50000, minCount = 0, maxCount = 1000, fingerprint = {{dmg=1.0,id="Forestry:craftingMaterial"}}, raw_name = {"item.craftingmaterial.pulsatingmesh"}},
		...
		{text = "Жемчуг Эндера", buyPrice = 6000, sellPrice = 5000, minCount = 0, maxCount = 5000, fingerprint = {{dmg=0.0,id="minecraft:ender_pearl"}}, raw_name = {"item.enderpearl"}},
		...
		{text = "Золотой слиток", buyPrice = 50, minCount = 0, maxCount = 15000,  fingerprint = {{dmg=0.0,id="minecraft:gold_ingot"}}, raw_name = {"item.ingotgold"}},
		...
		{text = "10.000$", buyPrice = 10000, sellPrice = 10000, minCount = 0, maxCount = 500, fingerprint = {{dmg=0.0,id="customnpcs:npcCoinBronze"}}, raw_name = {"item.npccoinbronze"}},
		{text = "100.000$", buyPrice = 100000, sellPrice = 100000, minCount = 0, maxCount = 500, fingerprint = {{dmg=0.0,id="customnpcs:npcCoinDiamond"}}, raw_name = {"item.npccoindiamond"}},
		...
		{text = "Драконий слиток", buyPrice = 700, minCount = 0, maxCount = 10000, fingerprint = {{dmg=0.0,id="DraconicEvolution:draconiumIngot"}}, raw_name = {"item.draconicevolution:draconiumingot"}},
