{
    shop = {
		...
		{text = "Душа", buyPrice = 15000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id=""}}, raw_name = {"item."}},
		{text = "Душа", buyPrice = 15000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id=""}}, raw_name = {"item."}},
		{text = "Изумрудная монета", sellPrice = 5000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id="customnpc:NpcCoinEmerald"}}, raw_name = {"item.npccoinemerald"}},
		{text = "Золотая монета", sellPrice = 4000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id="customnpc:NpcCoinGold"}}, raw_name = {"item.npccoingold"}},
		{text = "Железная монета", sellPrice = 2000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id="customnpc:NpcCoinIron"}}, raw_name = {"item.npccoiniron"}},
		{text = "Каменная монета", sellPrice = 1000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id="customnpc:NpcCoinStone"}}, raw_name = {"item.npccoinstone"}},
		{text = "Деревянная монета", sellPrice = 500, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id="customnpc:NpcCoinWooden"}}, raw_name = {"item.npccoinwooden"}},
		{text = "МЭ Накопитель", buyPrice = 1000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id="appliedenergestics2:tile.BlockDrive"}}, raw_name = {"tile.appliedenergestics2.blockdrive"}},
		...
		{text = "Плоскость истребления", buyPrice = 1000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=300.0,id="appliedenergestics2:item.ItemMultiPart"}}, raw_name = {"item.appliedenergestics2:itempart.annihilationplane"}},
		{text = "Продвинутый высекатель", buyPrice = 5000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id="ae2stuff:Inscriber"}}, raw_name = {"tile.ae2stuff:inscriber"}},
		{text = "Шина Импорта", buyPrice = 1000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=240.0,id="appliedenergestics2:item.ItemMultiPart"}}, raw_name = {"item.appliedenergestics2:itempart.importbus"}},
		{text = "Шина Экспорта", buyPrice = 1000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=260.0,id="appliedenergestics2:item.ItemMultiPart"}}, raw_name = {"item.appliedenergestics2:itempart.exportbus"}},
		...
		{text = "Жемчуг Эндера", buyPrice = 6000, sellPrice = 5000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id="minecraft:ender_pearl"}}, raw_name = {"item.enderpearl"}},
		{text = "Ядро Дракона", buyPrice = 75000, minCount = 0, maxCount = 15000, fingerprint = {{dmg=0.0,id="DraconicEvolution:DraconicCore"}}, raw_name = {"item.draconicevolution:draconiccore"}},
