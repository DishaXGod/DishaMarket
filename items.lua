{
    shop = {
		...
		{text = "Душа", buyPrice = 15000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id=""}}, raw_name = {"item."}},
		{text = "Душа", buyPrice = 15000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id=""}}, raw_name = {"item."}},
		{text = "Душа", buyPrice = 15000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id=""}}, raw_name = {"item.l"}},
		{text = "Продвинутый высекатель", buyPrice = 15000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id="ae2stuff:Inscriber"}}, raw_name = {"tile.ae2stuff:inscriber"}},
		{text = "Шина Импорта", buyPrice = 1000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id="appliedenergestics2:item.ItemMultiPart"}}, raw_name = {"item.appliedenergestics2:itempart.importbus"}},
		{text = "Шина Экспорта", buyPrice = 1000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=0.0,id="appliedenergestics2:item.ItemMultiPart"}}, raw_name = {"item.appliedenergestics2:itempart.exportbus"}},
