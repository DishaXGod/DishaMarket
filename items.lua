{
    shop = {
		...
		{text = "Капсула хладагента", buyPrice = 300, minCount = 0, maxCount = 15000, fingerprint = {{dmg=9.0,id="IC2:itemCellEmpty"}}, raw_name = {"ic2.itemcellcoolant"}},
		{text = "Излучающий уран", buyPrice = 1200, minCount = 0, maxCount = 15000, fingerprint = {{dmg=2.0,id="AdvancedSolarPanel:asp_crafting_items"}}, raw_name = {"itemirradianturanium"}},
		{text = "Слиток Композита", buyPrice = 400, minCount = 0, maxCount = 15000, fingerprint = {{dmg=4.0,id="IC2:itemIngot"}}, raw_name = {"ic2.itemingotalloy"}},
		{text = "Слиток Ламиумовый", buyPrice = 1000, minCount = 0, maxCount = 15000, fingerprint = {{dmg=75.0,id="ThermalFoundation:material"}}, raw_name = {"item.thermalfoundation.material.ingotlumium"}},
		{text = "Слиток Синалиновый", buyPrice = 200, minCount = 0, maxCount = 15000, fingerprint = {{dmg=74.0,id="ThermalFoundation:material"}}, raw_name = {"item.thermalfoundation.material.ingotsignalium"}},
		{text = "Слиток Бронзы", buyPrice = 100, minCount = 0, maxCount = 15000, fingerprint = {{dmg=0.0,id="Forestry:ingotBronze"}}, raw_name = {"item.for.ingotbronze"}},
		{text = "Слиток Инвара", buyPrice = 100, minCount = 0, maxCount = 15000, fingerprint = {{dmg=72.0,id="ThermalFoundation:material"}}, raw_name = {"item.thermalfoundation.material.ingotinvar"}},
		{text = "Солнечная панель 3 уровня", buyPrice = 160000, minCount = 0, maxCount = 500, fingerprint = {{dmg=1.0,id="CompactSolars:CompactSolarBlock"}}, raw_name = {"tile.compactsolars:mv_block"}},
		{text = "Душа", buyPrice = 15000, minCount = 0, maxCount = 50000, fingerprint = {{dmg=1.0,id=""}}, raw_name = {"item."}},
		...
		{text = "Дробитель", buyPrice = 1500, minCount = 0, maxCount = 5000, fingerprint = {{dmg=3.0,id="IC2:blockMachine"}}, raw_name = {"ic2.blockmecerator"}},
		{text = "Компрессор", buyPrice = 1500, minCount = 0, maxCount = 5000, fingerprint = {{dmg=5.0,id="IC2:blockMachine"}}, raw_name = {"ic2.blockcompressor"}},
		{text = "Доменная печь", buyPrice = 1500, minCount = 0, maxCount = 5000, fingerprint = {{dmg=1.0,id="IC2:blockMachine3"}}, raw_name = {"ic2.blockblastfurnace"}},
		{text = "Высекатель", buyPrice = 1500, minCount = 0, maxCount = 5000, fingerprint = {{dmg=0.0,id="appliedenergistics2:tile.BlockInscriber"}}, raw_name = {"tile.appliedenergistics2.blockinscriber"}},
		{text = "Отпечатанный лог. контур", buyPrice = 500, minCount = 0, maxCount = 5000, fingerprint = {{dmg=18.0,id="appliedenergistics2:item.ItemMultiMaterial"}}, raw_name = {"item.appliedenergestics2.itemmaterial.logicprocessorprint"}},
		{text = "Отпечатанный инж. контур", buyPrice = 500, minCount = 0, maxCount = 5000, fingerprint = {{dmg=17.0,id="appliedenergistics2:item.ItemMultiMaterial"}}, raw_name = {"item.appliedenergestics2.itemmaterial.engprocessorprint"}},
		{text = "Отпечатанный выч. контур", buyPrice = 500, minCount = 0, maxCount = 5000, fingerprint = {{dmg=16.0,id="appliedenergistics2:item.ItemMultiMaterial"}}, raw_name = {"item.appliedenergestics2.itemmaterial.calcprocessorprint"}},
		{text = "Пасека", buyPrice = 750, minCount = 0, maxCount = 5000, fingerprint = {{dmg=0.0,id="Forestry:apiculture"}}, raw_name = {"tile.for.apiculture.0"}},
		{text = "Кожа", buyPrice = 3000, minCount = 0, maxCount = 5000, fingerprint = {{dmg=0.0,id="minecraft:leather"}}, raw_name = {"item.leather"}},
		...
		{text = "Воск", buyPrice = 500, minCount = 0, maxCount = 10000, fingerprint = {{dmg=0.0,id="Forestry:beeswax"}}, raw_name = {"item.for.beeswax"}},
		...
		{text = "Пустой шаблон", buyPrice = 1500, minCount = 0, maxCount = 5000, fingerprint = {{dmg=52.0,id="appliedenergistics2:item.ItemMultiMaterial"}}, raw_name = {"item.appliedenergistics2.itemmaterial.blankpattern"}},
		{text = "Компонент хранения на 1К", buyPrice = 1000, minCount = 0, maxCount = 5000, fingerprint = {{dmg=35.0,id="appliedenergistics2:item.ItemMultiMaterial"}}, raw_name = {"item.appliedenergestics2.itemmaterial.cell1kpart"}},
		...
		{text = "Золотая монета", buyPrice = 15000, minCount = 0, maxCount = 500, fingerprint = {{dmg=0.0,id="customnpc:NpcCoinGold"}}, raw_name = {"item.npccoingold"}},		
		...
		{text = "МЭ Накопитель", buyPrice = 1000, minCount = 0, maxCount = 15000, fingerprint = {{dmg=0.0,id="appliedenergistics2:tile.BlockDrive"}}, raw_name = {"tile.appliedenergistics2.blockdrive"}},
		{text = "Блок создания", buyPrice = 1000, minCount = 0, maxCount = 15000, fingerprint = {{dmg=0.0,id="appliedenergistics2:tile.BlockCraftingUnit"}}, raw_name = {"tile.appliedenergistics2.blockcraftingunit"}},
		...
		{text = "Небесный камень", buyPrice = 500, minCount = 0, maxCount = 5000, fingerprint = {{dmg=0.0,id="appliedenergistics2:BlockSkyStone"}}, raw_name = {"item.appliedenergistics2.blockskystone"}},
		...
		{text = "Шина Импорта", buyPrice = 1000, minCount = 0, maxCount = 1000, fingerprint = {{dmg=240.0,id="appliedenergistics2:item.ItemMultiPart"}}, raw_name = {"item.appliedenergistics2:itempart.importbus"}},
		...
		{text = "Пресс выч. для высекателя", buyPrice = 15000, minCount = 0, maxCount = 500, fingerprint = {{id="appliedenergistics2:item.ItemMultiMaterial",dmg=13.0}}, raw_name = {"item.appliedenergistics2.itemmaterial.calcprocessorpress"}},
        	...
        	{text = "Светопыль", buyPrice = 300, minCount = 0, maxCount = 50000, fingerprint = {{id="minecraft:glowstone_dust",dmg=0.0}}, raw_name = {"item.yellowdust"}},
		{text = "Красная пыль", buyPrice = 20, minCount = 0, maxCount = 50000, fingerprint = {{id="minecraft:redstone",dmg=0.0}}, raw_name = {"item.redstone"}},
