...
buttons = {
    ...
    info = {buttonIn = {"main"}, disabledBackground = color.background, disabledForeground = color.blackLime, background = color.background, activeBackground = color.background, foreground = color.lime, activeForeground = color.blackLime, text = "[NWA]", x = 28, y = 19, width = 8, height = 1, action = function() toGui("info") end},
