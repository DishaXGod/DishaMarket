...
local function nextFood()
    if session.foodTime and time(true) < session.foodTime then
       ...
       set(nil, 6, os.date("%H Часов %M Минут %S Секунд", session.foodTime - time(true)), color.background, 0xFFD700)
       drawButton("getFood")
   else
...
buttons = {
    ...
    back = {buttonIn = {"shop", "buyItem", "sellItem", "other", "ore", "freeFood", "lottery", "account", "info", "feedbacks", "shop"}, background = color.gray, activeBackground = color.blackGray, foreground = color.orange, activeForeground = color.gold, text = "   Назад   ", x = 25, y = 18, width = 11, height = 1, action = function() back() end},
    backShop = {buttonIn = {"buy", "sell"}, background = color.gray, activeBackground = color.blackGray, foreground = color.orange, activeForeground = color.gold, text = "   Назад   ", x = 31, y = 18, width = 11, height = 1, action = function() back() end},
    ...
    feedbacks = {buttonIn = {"main"}, disabledBackground = color.background, disabledForeground = color.blackLime, background = color.background, activeBackground = color.background, foreground = color.gold, activeForeground = color.blackLime, text = "[Отзывы]", x = 53, y = 19, width = 8, height = 1, action = function() toGui("feedbacks") end},
    info = {buttonIn = {"main"}, disabledBackground = color.background, disabledForeground = color.blackLime, background = color.background, activeBackground = color.background, foreground = color.gold, activeForeground = color.blackLime, text = "[Помощь]", x = 1, y = 19, width = 8, height = 1, action = function() toGui("info") end},
    ...
    nextBuy = {buttonIn = {"buy"}, disabled = true, disabledBackground = color.blackGray, disabledForeground = color.blackOrange, background = color.gray, activeBackground = color.gold, foreground = color.gold, activeForeground = color.gold, text = "  Далее  ", x = 50, y = 18, width = 9, height = 1, action = function() buttons.purchase.disabled = true item = items.shop[lists[focus.list].scrollContent[lists[focus.list].scrollContent.activeIndex].index] toGui("buyItem", {item = item}) guiVariables[guiPath[#guiPath]].amount = 0 end},
    nextSell = {buttonIn = {"sell"}, disabled = true, disabledBackground = color.blackGray, disabledForeground = color.blackOrange, background = color.gray, activeBackground = color.gold, foreground = color.gold, activeForeground = color.gold, text = "  Далее  ", x = 50, y = 18, width = 9, height = 1, action = function() item = items.shop[lists[focus.list].scrollContent[lists[focus.list].scrollContent.activeIndex].index] toGui("sellItem", {item = item}) end},
    ...
    --lottery = {buttonIn = {"other"}, disabledBackground = color.blackGray, disabledForeground = color.blackLime, background = color.gray, activeBackground = color.blackGray, foreground = color.lime, activeForeground = color.blackLime, text = "Набор в NWA", x = 19, y = 12, width = 24, height = 3, action = function() toGui("lottery") end},
    ...
    zero = {buttonIn = {"buyItem"}, background = color.gray, activeBackground = color.blackGray, foreground = color.gold, activeForeground = color.blackOrange, text = "0", x = 29, y = 15, width = 3, height = 1, action = function() inputWrite("amount", 48) end},
    one = {buttonIn = {"buyItem"}, background = color.gray, activeBackground = color.blackGray, foreground = color.gold, activeForeground = color.blackOrange, text = "1", x = 24, y = 9, width = 3, height = 1, action = function() inputWrite("amount", 49) end},
    two = {buttonIn = {"buyItem"}, background = color.gray, activeBackground = color.blackGray, foreground = color.gold, activeForeground = color.blackOrange, text = "2", x = 29, y = 9, width = 3, height = 1, action = function() inputWrite("amount", 50) end},
    three = {buttonIn = {"buyItem"}, background = color.gray, activeBackground = color.blackGray, foreground = color.gold, activeForeground = color.blackOrange, text = "3", x = 34, y = 9, width = 3, height = 1, action = function() inputWrite("amount", 51) end},
    four = {buttonIn = {"buyItem"}, background = color.gray, activeBackground = color.blackGray, foreground = color.gold, activeForeground = color.blackOrange, text = "4", x = 24, y = 11, width = 3, height = 1, action = function() inputWrite("amount", 52) end},
    five = {buttonIn = {"buyItem"}, background = color.gray, activeBackground = color.blackGray, foreground = color.gold, activeForeground = color.blackOrange, text = "5", x = 29, y = 11, width = 3, height = 1, action = function() inputWrite("amount", 53) end},
    six = {buttonIn = {"buyItem"}, background = color.gray, activeBackground = color.blackGray, foreground = color.gold, activeForeground = color.blackOrange, text = "6", x = 34, y = 11, width = 3, height = 1, action = function() inputWrite("amount", 54) end},
    seven = {buttonIn = {"buyItem"}, background = color.gray, activeBackground = color.blackGray, foreground = color.gold, activeForeground = color.blackOrange, text = "7", x = 24, y = 13, width = 3, height = 1, action = function() inputWrite("amount", 55) end},
    eight = {buttonIn = {"buyItem"}, background = color.gray, activeBackground = color.blackGray, foreground = color.gold, activeForeground = color.blackOrange, text = "8", x = 29, y = 13, width = 3, height = 1, action = function() inputWrite("amount", 56) end},
    nine = {buttonIn = {"buyItem"}, background = color.gray, activeBackground = color.blackGray, foreground = color.gold, activeForeground = color.blackOrange, text = "9", x = 34, y = 13, width = 3, height = 1, action = function() inputWrite("amount", 57) end},
    backspace = {buttonIn = {"buyItem"}, background = color.gray, activeBackground = color.blackGray, foreground = color.red, activeForeground = color.blackOrange, text = "<", x = 24, y = 15, width = 3, height = 1, action = function() inputWrite("amount", 8) end},
    clear = {buttonIn = {"buyItem"}, background = color.gray, activeBackground = color.blackGray, foreground = color.red, activeForeground = color.blackOrange, text = "C", x = 34, y = 15, width = 3, height = 1, action = function() amount("C") end},
    ...
    prevInfo = {buttonIn = {"info"}, disabled = true, disabledBackground = color.background, disabledForeground = color.blackBlue, background = color.background, activeBackground = background, foreground = color.gold, activeForeground = color.gold, text = "<───", x = 21, y = 16, width = 4, height = 1, action = function() drawInfo(guiPage - 1) end},
    nextInfo = {buttonIn = {"info"}, disabled = true, disabledBackground = color.background, disabledForeground = color.blackBlue, background = color.background, activeBackground = background, foreground = color.gold, activeForeground = color.gold, text = "───>", x = 36, y = 16, width = 4, height = 1, action = function() drawInfo(guiPage + 1) end},
    
    acceptFeedback = {buttonIn = {"feedbacks"}, notVisible = true, background = color.background, activeBackground = color.background, foreground = color.gold, activeForeground = color.gold, text = "[Подтвердить]", x = 24, y = 14, width = 13, height = 1, action = function() acceptFeedback() end},
    prevFeedback = {buttonIn = {"feedbacks"}, disabled = true, disabledBackground = color.background, disabledForeground = color.blackBlue, background = color.background, activeBackground = background, foreground = color.gold, activeForeground = color.gold, text = "<───", x = 21, y = 16, width = 4, height = 1, action = function() drawFeedback(guiPage - 1) end},
    nextFeedback = {buttonIn = {"feedbacks"}, disabled = true, disabledBackground = color.background, disabledForeground = color.blackBlue, background = color.background, activeBackground = background, foreground = color.gold, activeForeground = color.gold, text = "───>", x = 36, y = 16, width = 4, height = 1, action = function() drawFeedback(guiPage + 1) end}
}
