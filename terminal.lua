...
buttons = {
    ...
    backShop = {buttonIn = {"buy", "sell"}, background = color.gray, activeBackground = color.blackGray, foreground = color.gold, activeForeground = color.orange, text = "   Назад   ", x = 31, y = 18, width = 11, height = 1, action = function() back() end},
