...
buttons = {
    ...
    info = {buttonIn = {"main"}, disabledBackground = color.background, disabledForeground = color.blackLime, background = color.background, activeBackground = color.background, foreground = color.lime, activeForeground = color.blackLime, text = "[Набор в NWA]", x = 1, y = 19, width = 8, height = 1, action = function() toGui("info") end},
